...
public interface ISqlExecutor
{
    ...
    ///     The parameters are automatically handled by Entity Framework to ensure they are properly escaped, reducing the risk
    ...
    ///     Uses a <see cref="FormattableString" /> to ensure that values are properly parameterized, preventing SQL injection
    ///     attacks.
    /// </summary>
