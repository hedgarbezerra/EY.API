...
public interface IHttpConsumer
{
    ...
    Task<Result<T>> Delete<T>(string url, List<KeyValuePair<string, string>> headers = null,
    ...
    /// <param name="cancellationToken">Optional cancellation token to cancel the request.</param>
    /// <returns>The task result contains a Result object, which includes the response deserialized into the specified type.</returns>
    Task<Result<T>> Get<T>(string url, List<KeyValuePair<string, string>> headers = null,
        CancellationToken cancellationToken = default);
    ...
    /// <param name="cancellationToken">Optional cancellation token to cancel the request.</param>
    /// <returns>The task result contains a Result object, which includes the response deserialized into the specified type.</returns>
    Task<Result<T>> Post<T>(string url, List<KeyValuePair<string, object>> param,
    ...
    /// <param name="cancellationToken">Optional cancellation token to cancel the request.</param>
    /// <returns>The task result contains a Result object, which includes the response deserialized into the specified type.</returns>
    Task<Result<T>> Post<T>(string url, object param, List<KeyValuePair<string, string>> headers = null,
        CancellationToken cancellationToken = default);
    ...
    /// <param name="cancellationToken">Optional cancellation token to cancel the request.</param>
    /// <returns>The task result contains a Result object, which includes the response deserialized into the specified type.</returns>
    Task<Result<T>> Put<T>(string url, List<KeyValuePair<string, object>> param,
        List<KeyValuePair<string, string>> headers = null, CancellationToken cancellationToken = default);
    ...
    /// <param name="cancellationToken">Optional cancellation token to cancel the request.</param>
    /// <returns>The task result contains a Result object, which includes the response deserialized into the specified type.</returns>
    Task<Result<T>> Put<T>(string url, object param, List<KeyValuePair<string, string>> headers = null,
        CancellationToken cancellationToken = default);
}