...
public class CountriesServiceTests
{
    ...
    public void Add_WhenCountryExists_ReturnsFailure()
    {
        ...
        countryRepository.Get().Returns(new List<Country>
            { new() { Name = "United States", TwoLetterCode = "USA", ThreeLetterCode = "USA" } }.AsQueryable());
    ...
    public void Add_WhenCountryDoesNotExist_AddsCountryAndReturnsSuccess()
    {
        ...
        countryRepository.Received(1).Add(Arg.Is<Country>(c =>
            c.Name == countryInput.Name && c.ThreeLetterCode == countryInput.ThreeLetterCode));
        _redisCache.DidNotReceive().AddAsync(Arg.Any<string>(), Arg.Any<Country>());
    }
