...
public class ExceptionsExtensionsTests
{
    [Test]
    public void
        IsAbortedRequestException_WithHttpRequestException_InnerExceptionIsTaskCanceledException_ShouldReturnTrue()
    {
        // Arrange
    ...
    [Test]
    public void
        IsAbortedRequestException_WithHttpRequestException_InnerExceptionIsNotTaskCanceledException_ShouldReturnFalse()
    {
        // Arrange
